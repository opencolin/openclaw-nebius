...
const CHAT_MODELS: NebiusModel[] = [
  ...
  { id: "Qwen/Qwen3-32B", name: "Qwen3 32B", contextWindow: 131072, maxTokens: 40960, input: ["text"], cost: { input: 0.1, output: 0.3, cacheRead: 0, cacheWrite: 0 }, reasoning: false },
  { id: "Qwen/Qwen3-30B-A3B-Thinking-2507", name: "Qwen3 30B Thinking", contextWindow: 131072, maxTokens: 40960, input: ["text"], cost: { input: 0.1, output: 0.3, cacheRead: 0, cacheWrite: 0 }, reasoning: true },
  { id: "Qwen/Qwen3-30B-A3B-Instruct-2507", name: "Qwen3 30B Instruct", contextWindow: 131072, maxTokens: 16384, input: ["text"], cost: { input: 0.1, output: 0.3, cacheRead: 0, cacheWrite: 0 }, reasoning: false },
  { id: "Qwen/Qwen3-Coder-30B-A3B-Instruct", name: "Qwen3 Coder 30B", contextWindow: 131072, maxTokens: 16384, input: ["text"], cost: { input: 0.1, output: 0.3, cacheRead: 0, cacheWrite: 0 }, reasoning: false },
